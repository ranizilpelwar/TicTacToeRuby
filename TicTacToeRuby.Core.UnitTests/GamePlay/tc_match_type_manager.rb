...
class TestMatchTypeManager < Test::Unit::TestCase
  ...
  def test_when_match_number_is_provided_as_zero_then_argument_error_is_raised
    match_type_manager = MatchTypeManager.new
    assert_raises ArgumentError do match_type_manager.get_match_type(0) end
  end

  def test_when_match_number_is_provided_as_four_then_argument_error_is_raised
    match_type_manager = MatchTypeManager.new
    assert_raises ArgumentError do match_type_manager.get_match_type(4) end
  end
