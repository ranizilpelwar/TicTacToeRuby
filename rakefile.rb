task :run_tests do
  ...
  ruby 'TicTacToeRuby.Core.UnitTests/Validators/tc_board_score_validation_parameterized_tests.rb'
  ruby 'TicTacToeRuby.Core.UnitTests/Validators/tc_board_score_validation.rb'
