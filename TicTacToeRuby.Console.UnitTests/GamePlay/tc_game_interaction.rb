...
class TestGameInteraction < Test::Unit::TestCase
  ...
  attr_reader :writer, :reader, :game_board, :player_manager, :last_moves_are_recorded, :match_type
  ...
  def test_raise_nil_reference_error_when_writer_is_nil
    assert_raises(NilReferenceError) do 
      ...
      GameInteraction.new(nil, @reader, @game_board, @player_manager, last_moves_are_recorded, @match_type)
    end
  end
  ...
  def test_raise_nil_reference_error_when_reader_is_nil
    assert_raises(NilReferenceError) do 
      last_moves_are_recorded = false
      GameInteraction.new(@writer, nil, @game_board, @player_manager, last_moves_are_recorded, @match_type)
    end
  end
  ...
  def test_raise_nil_reference_error_when_game_board_is_nil
    assert_raises(NilReferenceError) do 
      last_moves_are_recorded = false
      GameInteraction.new(@writer, @reader, nil, @player_manager, last_moves_are_recorded, @match_type)
    end
  end
  ...
  def test_raise_nil_reference_error_when_match_type_is_nil
    assert_raises(NilReferenceError) do 
      last_moves_are_recorded = false
      GameInteraction.new(@writer, @reader, @game_board, @player_manager, last_moves_are_recorded, nil)
    end
  end
